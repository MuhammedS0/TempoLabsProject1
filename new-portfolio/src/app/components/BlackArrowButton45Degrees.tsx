...
const BlackArrowButton45Degrees: React.FC = () => {
  return (
    <div className="flex justify-center items-center h-screen">
      <button
        className="w-[92px] h-[92px] p-[21px] origin-top-left -rotate-90 bg-[#151515] rounded-[57px] border-2 justify-center items-center flex"
      >
        <svg
          width="50"
          height="50"
...
export default BlackArrowButton45Degrees;
